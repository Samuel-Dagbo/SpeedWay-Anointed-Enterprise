  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-sm': '0 1px 4px -1px rgb(0 0 0 / 0.06), 0 2px 8px -2px rgb(0 0 0 / 0.08)',
        'soft-lg': '0 4px 12px -3px rgb(0 0 0 / 0.1), 0 8px 24px -4px rgb(0 0 0 / 0.15)',
        'glow': '0 0 20px -5px hsl(var(--primary) / 0.3)',
        'inner-soft': 'inset 0 2px 4px 0 rgb(0 0 0 / 0.05)',
      },
      animation: {
        'fade-in': 'fadeIn 0.5s ease-in-out',
        'fade-in-up': 'fadeInUp 0.4s cubic-bezier(.16,1,.3,1)',
